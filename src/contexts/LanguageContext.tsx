...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'cart.delivery_address': 'Delivery Address (Optional)',
    'cart.special_instructions': 'Special Instructions (Optional)',
    'cart.delivery_zone': 'Delivery Zone',
    'cart.order_summary': 'Order Summary',
    'cart.estimated_time': 'Estimated Time',
    'cart.order_details': 'ORDER DETAILS',
    'cart.financial_summary': 'FINANCIAL SUMMARY',
    'cart.subtotal_items': 'Subtotal items',
    'cart.special_notes': 'Special notes',
    'cart.order_placed_on': 'Order placed on',
    'cart.confirm_order': 'Please confirm this order and delivery time',
    'cart.new_order': 'NEW BUEADELIGHTS ORDER',
    'cart.client': 'Client',
    'cart.telephone': 'Telephone',
    'cart.delivery_zone_label': 'Delivery zone',
    'cart.address': 'Address',
    'cart.size': 'Size',
    'cart.unit_price': 'Unit price',
    'cart.subtotal_item': 'Subtotal',
    'cart.validation_empty': 'Your cart is empty',
    'cart.validation_name_phone': 'Please fill in your name and phone number',
    'cart.validation_delivery_zone': 'Please select a delivery zone',
    'cart.item_added': 'Item added to cart',
    'cart.item_removed': 'Item removed from cart',
    'cart.item_updated': 'Cart updated',
    
    // Services
    'services.international_title': 'International Services',
    'services.international_desc': 'We extend our authentic Cameroonian cuisine worldwide',
    'services.event_catering': 'Event Catering',
    'services.international_delivery': 'International Delivery',
    'services.staff_travel': 'Chef Travel Services',
    'services.wedding_package': 'Wedding Package',
    'services.birthday_package': 'Birthday Package', 
    'services.funeral_package': 'Funeral Package',
    'services.corporate_package': 'Corporate Package',
    'services.cultural_events': 'Cultural Events',
    'services.package_from': 'Starting from',
    'services.per_person': 'per person',
    'services.custom_quote': 'Custom Quote',
    'services.guest_count': 'Number of Guests',
    'services.event_date': 'Event Date',
    'services.event_location': 'Event Location',
    'services.package_includes': 'Package Includes',
    'services.request_quote': 'Request Quote',
    'services.contact_for_booking': 'Contact us for booking',
    
    // Event Packages Details
    'event.wedding.includes': 'Traditional ceremony menu, wedding cake, decorations, full service',
    'event.birthday.includes': 'Birthday menu, cake, decorations, entertainment coordination',
    'event.funeral.includes': 'Respectful catering, traditional dishes, full service, setup',
    'event.corporate.includes': 'Business lunch/dinner, professional service, custom menu',
    'event.cultural.includes': 'Traditional cultural dishes, authentic presentation, cultural setup',
    
    // International Services
    'intl.delivery.title': 'International Food Delivery',
    'intl.delivery.desc': 'We ship authentic Cameroonian ingredients and ready meals worldwide',
    'intl.delivery.countries': 'Available Countries',
    'intl.delivery.processing': 'Processing Time',
    'intl.delivery.packaging': 'Specialized Packaging',
    'intl.delivery.customs': 'Customs Assistance',
    
    'intl.chef.title': 'International Chef Services',
    'intl.chef.desc': 'Our professional chefs travel internationally for events and cooking services',
    'intl.chef.duration': 'Service Duration',
    'intl.chef.team_size': 'Team Size',
    'intl.chef.equipment': 'Equipment Provided',
    'intl.chef.languages': 'Languages Spoken',
  ...
  fr: {
    ...
    // Enhanced Cart
    'cart.customer_info': 'Informations Client',
    'cart.full_name': 'Nom Complet',
    'cart.phone_number': 'Numéro de Téléphone',
    'cart.delivery_address': 'Adresse de Livraison (Optionnel)',
    'cart.special_instructions': 'Instructions Spéciales (Optionnel)',
    'cart.delivery_zone': 'Zone de Livraison',
    'cart.order_summary': 'Résumé de Commande',
    'cart.estimated_time': 'Temps Estimé',
    'cart.order_details': 'DÉTAILS DE LA COMMANDE',
    'cart.financial_summary': 'RÉSUMÉ FINANCIER',
    'cart.subtotal_items': 'Sous-total plats',
    'cart.special_notes': 'Notes spéciales',
    'cart.order_placed_on': 'Commande passée le',
    'cart.confirm_order': 'Merci de confirmer cette commande et le délai de livraison',
    'cart.new_order': 'NOUVELLE COMMANDE BUEADELIGHTS',
    'cart.client': 'Client',
    'cart.telephone': 'Téléphone',
    'cart.delivery_zone_label': 'Zone de livraison',
    'cart.address': 'Adresse',
    'cart.size': 'Taille',
    'cart.unit_price': 'Prix unitaire',
    'cart.subtotal_item': 'Sous-total',
    'cart.validation_empty': 'Votre panier est vide',
    'cart.validation_name_phone': 'Veuillez remplir votre nom et numéro de téléphone',
    'cart.validation_delivery_zone': 'Veuillez sélectionner une zone de livraison',
    'cart.item_added': 'Article ajouté au panier',
    'cart.item_removed': 'Article retiré du panier',
    'cart.item_updated': 'Panier mis à jour',
    
    // Services
    'services.international_title': 'Services Internationaux',
    'services.international_desc': 'Nous étendons notre cuisine camerounaise authentique dans le monde entier',
    'services.event_catering': 'Traiteur d\'Événements',
    'services.international_delivery': 'Livraison Internationale',
    'services.staff_travel': 'Services de Chef Voyage',
    'services.wedding_package': 'Package Mariage',
    'services.birthday_package': 'Package Anniversaire',
    'services.funeral_package': 'Package Funérailles',
    'services.corporate_package': 'Package Corporatif',
    'services.cultural_events': 'Événements Culturels',
    'services.package_from': 'À partir de',
    'services.per_person': 'par personne',
    'services.custom_quote': 'Devis Personnalisé',
    'services.guest_count': 'Nombre d\'Invités',
    'services.event_date': 'Date de l\'Événement',
    'services.event_location': 'Lieu de l\'Événement',
    'services.package_includes': 'Le Package Inclut',
    'services.request_quote': 'Demander un Devis',
    'services.contact_for_booking': 'Contactez-nous pour réservation',
    
    // Event Packages Details
    'event.wedding.includes': 'Menu de cérémonie traditionnelle, gâteau de mariage, décorations, service complet',
    'event.birthday.includes': 'Menu d\'anniversaire, gâteau, décorations, coordination de divertissement',
    'event.funeral.includes': 'Traiteur respectueux, plats traditionnels, service complet, installation',
    'event.corporate.includes': 'Déjeuner/dîner d\'affaires, service professionnel, menu personnalisé',
    'event.cultural.includes': 'Plats culturels traditionnels, présentation authentique, installation culturelle',
    
    // International Services
    'intl.delivery.title': 'Livraison Alimentaire Internationale',
    'intl.delivery.desc': 'Nous expédions des ingrédients camerounais authentiques et des plats préparés dans le monde entier',
    'intl.delivery.countries': 'Pays Disponibles',
    'intl.delivery.processing': 'Temps de Traitement',
    'intl.delivery.packaging': 'Emballage Spécialisé',
    'intl.delivery.customs': 'Assistance Douanière',
    
    'intl.chef.title': 'Services de Chef International',
    'intl.chef.desc': 'Nos chefs professionnels voyagent internationalement pour des événements et services de cuisine',
    'intl.chef.duration': 'Durée du Service',
    'intl.chef.team_size': 'Taille de l\'Équipe',
    'intl.chef.equipment': 'Équipement Fourni',
    'intl.chef.languages': 'Langues Parlées',
